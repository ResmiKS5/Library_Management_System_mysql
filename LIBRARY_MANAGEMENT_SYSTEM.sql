...
('978-04-67890-09-8','keenavum kannerum','History',20.00,'Yes','V T Bhattathiripad','GGG');
select * from Books;
...
(408,124,'Naalukettu','2022-12-12','978-02-67890-09-8'),
(409,131,'Oru Sangeerthanam pole','2023-01-02','978-03-67890-09-8'),
(410,132,'keenavum kannerum','2023-02-14','978-04-67890-09-8');
...
(08,124,'Naalukettu','2023-01-12','978-02-67890-09-8'),
(09,131,'Oru Sangeerthanam pole','2023-02-02','978-03-67890-09-8'),
(10,132,'keenavum kannerum','2023-03-14','978-04-67890-09-8');
